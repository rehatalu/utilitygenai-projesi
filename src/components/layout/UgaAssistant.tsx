...
export default function UgaAssistant() {
  ...
  return (
    <>
      ...
      >
        <div className="relative w-32 h-32 animate-float rounded-full transition-transform hover:scale-110 focus:outline-none">
          <Image
            src="/uga.png"
            alt="UGA Assistant"
            fill
      ...
      {isChatOpen && (
        <div className="fixed bottom-24 right-8 z-50 w-72">
          <button
            ...
            className="absolute -top-2 -right-2 z-20 rounded-full bg-red-500 p-1 text-white hover:bg-red-600"
          >
