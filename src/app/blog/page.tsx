  ...
  return (
    <WorkspaceLayout>
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {posts.length === 0 ? (
          <div className="text-center text-slate-500 py-10 border border-dashed border-slate-300 dark:border-slate-700 rounded-xl">
            <p>No articles found. Please add Markdown files to src/content/blog/</p>
          </div>
        ) : (
