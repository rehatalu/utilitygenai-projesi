        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-12 px-6 py-24 text-white lg:flex-row lg:items-center lg:justify-between lg:gap-16">
          ...
          <div className="relative mx-auto max-w-xl lg:mx-0">
            <div className="relative">
              <div className="pointer-events-none absolute -top-12 -right-6 z-20 flex h-12 w-32 items-center justify-center rounded-full bg-white/20 text-sm font-medium text-white/80 backdrop-blur">
                New tools weekly
              </div>
              <div className="pointer-events-none animate-float-slow absolute -left-24 top-16 z-10 hidden rounded-2xl border border-white/40 bg-white/10 p-4 text-white/80 backdrop-blur md:block">
              ...
              <div className="pointer-events-none animate-float-slower absolute -bottom-10 -right-16 z-10 hidden w-48 rounded-2xl border border-white/40 bg-white/10 p-4 text-white/80 backdrop-blur md:block">
